  ...
  */
  ...
  class Sky extends EventEmitter{
    constructor(option){
      ...
      if(option.element === undefined){
        ...
        this.element = div;
      } else if(otpion.elementID !== undefined){
        this.element = document.getElementById(option.elementID)
      }
      else if(option.element !== undefined){
  ...
  class Cloud{
    ...
    createCloudElement(){
      ...
      var svg = parser.parseFromString(`<svg class="cloud" version="1.0" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" viewBox="300 176.5 245 180" style="enable-background:new 343.523 211.385 160.252 109.403; position: absolute;" xml:space="preserve">
      <defs>
    ...
    setAnimation(option){
      ...
      if(option.around){this.animator.addGoAround(option);}
        ...
        if(option.x !== undefined && option.y !== undefined){
          ...
          this.setPosition(generateRandomInt(0, w-150), generateRandomInt(0, h-150));
        }
